...
const cards = [
    { id: 1, header: "⌛ H.O.M.O.K.", text: "Hatalmas Ősi Megbízatások és Oltalmak Keresői" },
    { id: 2, header: "🌟 F.E.N.Y. ", text: "Felfedezők Elveszett Nemzetek" },
    { id: 3, header: "🏴‍☠️ K.I.N.C.S.", text: "Királyságok, Istenségek, Nagy Csodák Szerzői" },
    { id: 4, header: "👑 K.O.R.O.N.A.", text: "Kastélykutatók Ősi Rejtelmek és Nemességek Atyjaitól" },
    { id: 5, header: "🗺 R.O.M.", text: "Régiségek, Oltalmak és Mítoszok Kutatóhálózata" },
]
...
export default function Sponsors() {
    ...
    const { x, containerRef, controls } = useInfiniteScroll(itemWidth, cards.length)

    return (
        <div className="flex flex-col items-center p-12">
            <h1 className="text-2xl text-center">Kutatók, régészek, csoportok akik a felfedezést elősegítették.</h1>
